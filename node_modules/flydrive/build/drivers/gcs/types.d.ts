...
type GCSDriverBaseOptions = {
    ...
    urlBuilder?: {
         ...
         */
        generateSignedURL?(key: string, bucket: string, config: GetSignedUrlConfig, storage: Storage): Promise<string>;
        /**
         * Custom implementation for creating signed/temporary URLs for uploading files
         */
        generateSignedUploadURL?(key: string, bucket: string, config: GetSignedUrlConfig, storage: Storage): Promise<string>;
    };
};
/**
...
export type GCSDriverOptions = ({
     ...
     */
    storage: Storage;
} & GCSDriverBaseOptions) | (StorageOptions & GCSDriverBaseOptions);
export {};

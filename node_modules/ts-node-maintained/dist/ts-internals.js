...
function createTsInternalsUncached(_ts) {
    ...
    function getExtendsConfigPath(extendedConfig, host, basePath, errors, createDiagnostic) {
        ...
        const tsGte5_0_0 = (0, util_1.versionGteLt)(ts.version, '5.0.0');
        const resolved = tsGte5_0_0
            ? ts.nodeNextJsonConfigResolver(extendedConfig, combinePaths(basePath, 'tsconfig.json'), host)
            : ts.nodeModuleNameResolver(extendedConfig, combinePaths(basePath, 'tsconfig.json'), { moduleResolution: ts.ModuleResolutionKind.NodeJs }, host, 
            /*cache*/ undefined, 
